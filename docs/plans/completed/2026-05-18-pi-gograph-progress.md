...
| # | Status | Task | Commit |
|---|--------|------|--------|
| 1 | ✅ done | Create project structure and package.json | 2b1086a |
| 2 | ✅ done | Implement detect.ts — Go repo and gograph detection (checkpoint: test) | ad4f62e |
| 3 | ✅ done | Implement runner.ts — gograph CLI wrapper | 576815c |
| 4 | ✅ done | Implement commands.ts — /gograph-setup, /gograph-status, /gograph-build | 78b77c3 |
